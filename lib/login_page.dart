...
import 'package:MoneyLotto/themes/theme.dart' as Theme;
import 'package:MoneyLotto/animations/bubble_indication_painter.dart';
import 'package:flutter/cupertino.dart';
import 'package:cloud_firestore/cloud_firestore.dart';
import 'dart:async';
import 'package:flutter_icons/flutter_icons.dart';
import 'package:MoneyLotto/home/forceUpdate.dart';
    ...
    _auth.onAuthStateChanged.listen((user) { 
      if (user != null) {
        Navigator.push(
          ...
          MaterialPageRoute(
              builder: (context) =>
                  HomeNewScreen(currentUserId: prefs.getString('id'))),
        );
      }     
    });
